...
[BASE] = KEYMAP( /* Base */
  ...
  KC_TAB,  DV_QUOT, DV_COMM, DV_DOT,  DV_P,    DV_Y,    DV_BSLS,          DV_EQL,  DV_F,    DV_G,    DV_C,    DV_R,  DV_L,    DV_SLSH,
  KC_LCTL, DV_A,    DV_O,    DV_E,    DV_U,    DV_I,    DV_EQL,           KC_ENT,  DV_D,    DV_H,    DV_T,    DV_N,  DV_S,    DV_MINS,
